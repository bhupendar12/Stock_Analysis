import requests  # Web se data lene ke liye requests library import kar rahe hain
from bs4 import BeautifulSoup  # HTML ko parse (read/scrape) karne ke liye BeautifulSoup import kar rahe hain
